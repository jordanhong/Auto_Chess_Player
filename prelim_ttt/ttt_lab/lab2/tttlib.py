...
#generate a set of candidate next steps by enqueuing these next steps 
# i.e the board states that results when these next steps were taken
#then evaluate the nextsteps to select the best move
